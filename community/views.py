...
def getUsersCommentsAll(request, id, page):
    print(">>>1: " + str(request.user_agents.is_mobile))
    print(">>>2: " + str(request.user_agents.is_tablet))
    print(">>>3: " + str(request.user_agents.is_touch_capable))
    print(">>>4: " + str(request.user_agents.is_pc))
    print(">>>5: " + str(request.user_agents.is_bot))
    print(">>>6: " + str(request.user_agents.browser))
    print(">>>7: " + str(request.user_agents.os))
    print(">>>7: " + str(request.user_agents.device))
